...
Чтобы устранить уязвимость, нужно создавать пользователя в образе, наделять его минимально-необходимыми правами и запускать контейнер от его имени с помощью USER.  
